...
export default function DualActionCards() {
  return (
    <section className="py-14 md:py-20 lg:py-24 bg-white z-20">
      <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {/* Card 1 */}
          <AnimateIn direction="left" delay={0.1}>
            <motion.div
              className="bg-primary p-6 md:p-8 lg:p-12 rounded-2xl text-white relative overflow-hidden h-full"
              whileHover={{ y: -6 }}
              transition={{ type: "spring", stiffness: 200 }}
            >
              <div className="relative z-10">
                <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 font-manrope">
                  Shahbaz Sharif Merit Scholarship
                </h3>
                <p className="text-white/80 mb-6 md:mb-10 text-base md:text-lg leading-relaxed max-w-md">
          ...
          <AnimateIn direction="right" delay={0.2}>
            <motion.div
              className="bg-[#0c1525] p-6 md:p-8 lg:p-12 rounded-2xl text-white relative overflow-hidden h-full"
              whileHover={{ y: -6 }}
              transition={{ type: "spring", stiffness: 200 }}
            >
              <div className="relative z-10">
