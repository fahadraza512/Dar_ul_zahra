    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full h-full flex flex-col lg:flex-row overflow-hidden">
          ...
          {/* LEFT — text block */}
          <motion.div
            className="flex-1 min-w-0 flex flex-col justify-center px-4 md:px-8 lg:px-24 pt-16 md:pt-20 lg:pt-0 pb-2 lg:pb-0"
          ...
          <motion.div
            className="shrink-0 w-full lg:w-96 flex items-center justify-center px-4 md:px-8 lg:px-8 pb-4 lg:pb-0"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
