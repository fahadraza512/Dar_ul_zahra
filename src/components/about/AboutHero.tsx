    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full h-full flex flex-col lg:flex-row overflow-hidden items-start lg:items-center">
          ...
          {/* LEFT — text block */}
          <motion.div
            className="w-full lg:flex-1 min-w-0 flex flex-col justify-center px-4 md:px-8 lg:px-24 pt-28 md:pt-32 lg:pt-0 pb-0"
          ...
          <motion.div
            className="shrink-0 w-full lg:w-96 flex items-start lg:items-center justify-center px-4 md:px-8 lg:px-8 pt-8 pb-6 lg:pt-0 lg:pb-0"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
