    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Left — collage matching ilm.fund layout */}
          <AnimateIn direction="left">
            <div className="relative" style={{ height: 740 }}>

              {/* Main large image — full width, top */}
              <motion.div
                className="absolute top-0 left-0 right-0 overflow-hidden rounded-3xl shadow-xl"
                style={{ height: 440, zIndex: 0, left: "18%", right: 0 }}
              ...
              {/* Second image — absolutely positioned, bottom-left, overlaps main */}
              <motion.div
                className="absolute overflow-hidden rounded-3xl shadow-2xl"
                style={{ width: "55%", height: 280, bottom: 160, left: 0, zIndex: 10, border: "20px solid white", borderRadius: "24px" }}
              ...
              {/* Orange funfact badge — bottom-right */}
              <motion.div
                className="absolute bg-primary text-white rounded-2xl shadow-xl flex flex-col items-center justify-center text-center px-6 gap-3"
                style={{ width: "38%", height: 200, bottom: 160, right: 0, zIndex: 20 }}
                initial={{ opacity: 0, scale: 0.85 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ delay: 0.3, type: "spring", stiffness: 180 }}
              >
                {/* Original SVG icon from ilm.fund */}
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="44" viewBox="0 0 58 52" fill="none" className="text-white/80">
                ...
                <p className="font-bold text-sm leading-snug">A Journey of 3 Decades</p>
          ...
          <AnimateIn direction="right" delay={0.15}>
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-[#0c1525] mb-6 leading-tight font-manrope">
              Shaping Education <span className="text-primary">Through Generosity</span>
            </h2>
            <p className="text-[#5e6d82] leading-relaxed mb-4 text-lg">
            ...
            <motion.button
              className="bg-primary text-white px-8 py-3.5 rounded-full font-semibold hover:bg-primary-dark transition-colors inline-flex items-center gap-2"
